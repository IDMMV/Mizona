...
function App(){
 ...
 const pages={
  panel:<Panel setPage={setPage}/>, community:<Community setPage={setPage}/>, school:<SchoolPage setPage={setPage}/>,
  chat:<Chat setPage={setPage}/>, transfer:<Transfer/>, benefits:<Benefits/>, businesses:<Businesses/>,
  marketplace:<Marketplace/>, business:<BusinessSuite/>, campus:<Campus/>, ride:<Ride/>,
  ai:<AiAssistant setPage={setPage}/>, admin:<Admin/>, settings:<Account/>, blueprint:<Blueprint/>
 };
