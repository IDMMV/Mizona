...
export default function Admin(){
 ...
 const tabs=[{id:'modules',label:'Módulos',icon:'🧩'},{id:'benefits',label:'Beneficios',icon:'🎁'},{id:'places',label:'Negocios',icon:'🏪'},{id:'security',label:'Seguridad',icon:'🛡️'},{id:'storage',label:'Storage',icon:'🧹'}];
