...
export default function BusinessSuite(){
  ...
  const finishSale=()=>safe(()=>{
    ...
    setLastReceipt(receipt);setCart([]);setCash('');setCustomerName('');setSelectedCustomer('');setNotice(`Venta ${receipt.receipt} registrada y enviada al flujo de pedidos.`);setTab('kitchen');return receipt;
  });
