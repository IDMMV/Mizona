...
import { AlertTriangle, Banknote, BarChart3, Briefcase, CheckCircle2, ChefHat, ClipboardList, Clock3, Coins, CreditCard, Download, Lock, Minus, Package, Plus, Printer, Receipt, Search, Settings, ShoppingCart, Store, Trash2, Trophy, Truck, User, UserPlus, Users, WalletCards, XCircle } from 'lucide-react';
...
export default function BusinessSuite(){
  ...
  if(!snapshot)return <div className="page"><Card title="Sin acceso" icon={<Lock size={18}/>}><p>No se encontró un negocio disponible para este perfil.</p></Card></div>;
