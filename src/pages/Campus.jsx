...
import {
  ...
  ClipboardCheck, Clock3, Download, FileText, Flag, GraduationCap, Heart,
  LockKeyhole, PlayCircle, Plus, Search, Sparkles, Star, Trophy, Upload,
  ...
  return <div className="modalBackdrop" onMouseDown={event=>event.target===event.currentTarget&&onClose()}>
    <div className="courseModal campusCourseModalV18">
      ...
      <div className="courseModalBody">
        ...
        <aside>
          <Card title="Información" icon="📘"><ul className="list"><li>{course.duration} de contenido.</li><li>{course.students} estudiantes locales.</li><li>{course.requirements}</li><li>{course.certificate?'Certificado disponible.':'Sin certificado.'}</li></ul></Card>
